...
If you wish to compile the program yourself, pick your favorite C++ compiler and build an executable using all *.cpp* and all *.h* files in the *src* folder of this repository. Note that your compiler needs to use the C++ 17 language standard.
